$(function () {
    ...
    $('.main_living .arrows .prev').on('click', function () {
        $('.main_living_slide').slick('slickPrev');
    });

    $('.main_living .arrows .next').on('click', function () {
        $('.main_living_slide').slick('slickNext');
    });
